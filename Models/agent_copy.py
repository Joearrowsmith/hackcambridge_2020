...
class DQNAgent:
    def __init__(self):
        ...
        self.model = self._build_model(10)
        self.target_model = self._build_model(10)
    ...
    def _build_model(self, batch_size, time_steps=25, window_onehot_shape=(9,9,7), dropout=0.0, recurrent_dropout=0.0):
        ...
        self.grid_inputs = tf.keras.Input(shape=self.grid_input_shape, name='reccurrent_grid_inputs')
